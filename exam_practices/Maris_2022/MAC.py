...
def createMAC():
    return f"{denary_to_hex(randomnumber(0, 255))}:{denary_to_hex(randomnumber(0, 255))}:{denary_to_hex(randomnumber(0, 255))}:{denary_to_hex(randomnumber(0, 255))}:{denary_to_hex(randomnumber(0, 255))}:{denary_to_hex(randomnumber(0, 255))}"
